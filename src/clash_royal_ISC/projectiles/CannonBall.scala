...
class CannonBall(attackDamage: Int ,position: Vector2, target: Entity) extends Projectile(attackDamage, position, target) {
  ...
  override val spriteSheet: Spritesheet = new Spritesheet("res/sprites/projectiles/cannon-ball.png", this.spriteWidth, this.spriteHeight)
